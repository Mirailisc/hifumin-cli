...
const multiBar = new cliProgress.MultiBar({
    ...
    hideCursor: true,
    format: ansi_colors_1.default.cyan('{bar}') + ' | {filename} | {percentage}%',
...
const getThumbnail = (id, mediaId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return new Promise((resolve, reject) => {
        res.data
            .pipe(fs.createWriteStream(exportPath + constants_1.FILE_COVER_PATH))
            .on('error', reject)
            .once('close', () => resolve(exportPath + constants_1.FILE_COVER_PATH));
    });
});
